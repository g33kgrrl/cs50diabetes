...
<div class="twoCols">
    ...
    <?php foreach ($carbLog as $testDate => $entries): ?>
    <?php $carbDailyAvg = load_carbDailyAvg($carbLog[$testDate]); ?>
...
?>
    ...
    <?php endforeach ?>
    <div class="medred">
        <a href="carbgraph.php">Graph It!</a>
    </div>
...
<div class="twoCols">
    ...
    <table class="bg">
        ...
        <tbody>
            ...
            <?php foreach ($carbMealtimeAvgs as $carbMealtimeAvg => $value): ?>

            <tr class="<?= $carbMealtimeAvg ?>">
                <td><?= $carbMealtimeAvg ?></td>
                <td><?= $value ?></td>
            </tr>
            <?php endforeach ?>
        </tbody>
